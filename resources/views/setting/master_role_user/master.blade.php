                                ...
                                foreach ($role as $zn) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="/setting/roleUser/delete?d={{ $zn->role_id }}" onclick="return confirm('Yakin Hapus ?')" class='text-danger '><i class="fas fa-trash"></i></a>


                                            <a data-toggle="modal" data-target="#edit-data" class="text-success  ml-3 " data-backdrop="static" data-keyboard="false" data-id="<?= $zn->role_id ?>" data-status="<?= $zn->status ?>" data-idrole="<?= $zn->role_id ?>" data-level="<?= $zn->level ?>"><i class="fa fa-edit"></i></a>
