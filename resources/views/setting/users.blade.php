        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <a class="btn btn-sm btn-primary" href="/setting/add_users"><i class="fa fa-plus"></i>
                            Tambah Users
                        </a>

                        <div class="table-responsive">
                            <table id="example2" style="width:100%" class="table table-striped table-sm text-center">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/setting/delete?d={{ $u->npk}}" onclick="return confirm('Yakin Hapus ?')" class='text-danger' title="hapus data"><i class="fa fa-trash"></i></a>
                                            ...
                                            <a href="/setting/form_edit?id={{ $u->npk }}" class='ml-2 text-success' title="edit data"><i class="fa fa-edit"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
