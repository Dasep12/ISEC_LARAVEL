        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <form onsubmit="return cek()" action="{{ route('settings.update') }}" method="POST">
                        @csrf
                        <div class="card-body">
                            ...
                            <a href="{{ route('settings.master') }}" class="btn btn-success btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
