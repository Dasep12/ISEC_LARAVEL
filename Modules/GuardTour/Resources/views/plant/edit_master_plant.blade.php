        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <form onsubmit="return cek()" action="{{ route('plant.update') }}" method="POST">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <input type="hidden" name="plant_id" id="plant_id" value="{{ $data->plant_id }}">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="comp_id" id="comp_id">
                                            ...
                                            <option {{ $c->company_id == $data->siteDetails->admisecsgp_mstcmp_company_id ? 'selected' : '' }} value="{{ $c->company_id }}">{{ $c->comp_name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group" id="list_wilayah">
                                        ...
                                        <select class="form-control" name="site_id" id="site_id">
                                            ...
                                            <option value="">{{ $data->siteDetails->site_name }}</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label for="">NAMA PLANT</label>
                                        <input type="text" name="plant_name" value="{{ $data->plant_name }}" autocomplete="off" id="plant_name" class="form-control">
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $data->kode_plant }}" name="kode_plant" autocomplete="off" id="kodeplant" class="form-control">
                                    </div>
        ...
        $.ajax({
            ...
            success: function(e) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    var site_id_ = "{{ $data->admisecsgp_mstsite_site_id }}";
                    $("select option[value='" + site_id_ + "']").attr('selected', 'selected');
                }
            }
        })
    }
    getWilayah('<?= $data->siteDetails->admisecsgp_mstcmp_company_id ?>')
    $(function() {
