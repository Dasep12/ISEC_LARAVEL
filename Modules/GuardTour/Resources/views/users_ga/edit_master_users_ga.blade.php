        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('users_ga.master')}}">Master Users GA</a></li>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <form onsubmit="return cek()" action="{{ route('users_ga.update') }}" method="POST">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="plant_id" id="plant_id" required>
                                            ...
                                            <option {{ $data->admisecsgp_mstplant_plant_id == $plant->plant_id ? 'selected' : '' }} value="{{ $plant->plant_id }}">{{ $plant->plant_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label for="">NAMA</label>
                                        <input type="text" name="nama" value="{{ $data->name }}" autocomplete="off" id="nama" class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="email">EMAIL</label>
                                        <input type="text" value="{{ $data->email }}" name="email" autocomplete="off" id="email" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="type" class="form-control" id="" required>
                                            <option {{ $data->type == 1 ? 'selected' : '' }} value="1">GA</option>
                                            <option {{ $data->type == 0 ? 'selected' : '' }} value="0">CC</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
