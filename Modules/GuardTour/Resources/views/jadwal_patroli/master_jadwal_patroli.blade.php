    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                @endif
                <a class="mb-2 btn btn-sm btn-success" href="{{ route('jadpatroli.form_upload') }}"><i class="fa fa-file-excel"></i>
                    Upload Jadwal
                </a>
                <div class="card">
                        ...
                        <form method="post" enctype="multipart/form-data" action="{{ route('jadpatroli.master') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 mt-2">
                                    <button type="submit" class="btn btn-sm btn-primary"><i class="fas fa-search"></i> Lihat Jadwal</button>
                                </div>
                            </div>
