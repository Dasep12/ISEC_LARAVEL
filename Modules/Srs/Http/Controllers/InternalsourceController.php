    ...
    public function edit($id, Request $request)
    {
        ...
        else
        {
            ...
            if($get_edit !== NULL)
            {
                ...
                // AREA
                $data_subarea = InternalsourceModel::sub_area();
                $data_subarea2 = InternalsourceModel::sub_area2($request, $data_edit->area_sub1_id);
                $data_subarea3 = InternalsourceModel::sub_area2($request, $data_edit->area_sub2_id);

                // RISK SOURCE
                $data_rso = InternalsourceModel::risk_source();
                $data_rso1 = InternalsourceModel::sub_risksource($request, $data_edit->risk_source_id);
                $data_rso2 = InternalsourceModel::sub_risksource($request, $data_edit->risksource_sub1_id);
                ...
                $data_ass = InternalsourceModel::assest();
                $no = InternalsourceModel::no_urut();
                $data_subass = InternalsourceModel::sub_assets($request, $data_edit->assets_id);
                $data_subass2 = InternalsourceModel::sub_assets($request, $data_edit->assets_sub1_id);
