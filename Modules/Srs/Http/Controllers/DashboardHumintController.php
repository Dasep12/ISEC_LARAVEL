...
use Modules\Srs\Entities\DashboardHumintModel;

class DashboardHumintController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data_area = DashboardHumintModel::area();
        $risk = DashboardHumintModel::risk();
        $target_assets = DashboardHumintModel::target_assets();
        $grap_risk = DashboardHumintModel::grap_risk($request);
        $grap_risk_source = DashboardHumintModel::grap_risk_source($request);
        $grap_trans_month = DashboardHumintModel::grap_trans_month($request);
        $grap_trans_area = DashboardHumintModel::grap_trans_area($request);
        $grap_trans = DashboardHumintModel::grap_trans($request);
        $grap_target_assets = DashboardHumintModel::grap_target_assets($request);
        $res_iso = DashboardHumintModel::grap_srs($request);
        $res_soi = DashboardHumintModel::grap_soi($request);
        $res_soi_avg_month = DashboardHumintModel::grap_soi_avg_month($request);
        $res_soi_avgpilar = DashboardHumintModel::grap_soi_avgpilar($request);
        $res_soi_montharea = DashboardHumintModel::grap_soi_avg_montharea($request);
        $current_year = date('Y');
        ...
        return view('srs::dashboardHumint', $data);
    }
    ...
    public function grapReload(Request $request)
    {
        $res_iso = DashboardHumintModel::grap_srs($request);
        $res_soi = DashboardHumintModel::grap_soi($request);
        $res_risk_source = DashboardHumintModel::grap_risk_source($request);
        $res_risk = DashboardHumintModel::grap_risk($request);
        $res_target_assets = DashboardHumintModel::grap_target_assets($request);
        $res_trans_month = DashboardHumintModel::grap_trans_month($request);
        $res_trans_area = DashboardHumintModel::grap_trans_area($request);
        $res_trans = DashboardHumintModel::grap_trans($request);
        $res_soi_avg_month = DashboardHumintModel::grap_soi_avg_month($request);
        $res_soi_avgpilar = DashboardHumintModel::grap_soi_avgpilar($request);
        $res_soi_montharea = DashboardHumintModel::grap_soi_avg_montharea($request);
    ...
    {
        // TREND YEAR MODEL
        $res_trend_year = DashboardHumintModel::grapTrendSoi($req);
    ...
    {
        $grap_risk_source = DashboardHumintModel::grapTopIndex($req);
    ...
    public function grapDetailRiskSource(Request $req)
    {
        ...
        $res_riSo_detail = DashboardHumintModel::grapDetailRiskSource($req, 'risk_source_id');
        // GRAP RISK SOURCE - MONTH //
        $res_riSo_month_sub1 = DashboardHumintModel::grapDetailRiskSource($req, 'risksource_sub1_id');
        // GRAP RISK SOURCE SUB 1 - TOTAL //
        $res_riSosub1_detail = DashboardHumintModel::grapDetailRiskSourceSub($req, 'risksource_sub1_id');
        // GRAP RISK SOURCE SUB 2 - TOTAL //
        $res_risksub2_detail = DashboardHumintModel::grapDetailRiskSourceSub($req, 'risksource_sub2_id');
        // RISK SOURCE SUB 2 MONTH //
        $res_riSo_month_sub2 = DashboardHumintModel::grapDetailRiskSource($req, 'risksource_sub2_id');
    ...
    {
        // Main assets data
        $res_assets_detail = DashboardHumintModel::grapDetailAssets($req, 'assets_id');
        // TARGET ASSETS SUB 1 MONTH
        $res_assets_sub1_month = DashboardHumintModel::grapDetailAssets($req, 'assets_sub1_id');
        // TARGET ASSETS SUB 1
        $res_assetssub1_detail = DashboardHumintModel::grapDetailAssetsSub($req, 'assets_sub1_id');
        // TARGET ASSETS SUB 2
        $res_assetssub2_detail = DashboardHumintModel::grapDetailAssetsSub($req, 'assets_sub2_id');
        // TARGET ASSETS SUB 2 MONTH
        $res_assets_sub2_month = DashboardHumintModel::grapDetailAssets($req, 'assets_sub2_id');
    ...
    {
        $res_risk_detail = DashboardHumintModel::grapDetailRisk($req, 'risk_id');
        $res_risk_sub1 = DashboardHumintModel::grapDetailRiskSub($req, 'risk_sub1_id');
        $res_risk_sub1_month = DashboardHumintModel::grapDetailRisk($req, 'risk_sub1_id');
        $res_risk_sub2 = DashboardHumintModel::grapDetailRiskSub($req, 'risk_sub2_id');
        $res_risk_sub2_month = DashboardHumintModel::grapDetailRisk($req, 'risk_sub2_id');
