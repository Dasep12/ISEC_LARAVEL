...
class DashboardController extends Controller
{
    ...
    public function grapDetailRiskSource(Request $req)
    {
        ...
        $res_riSo_detail = DashboardModel::grapDetailRiskSource($req, 'risk_source_id');
        // GRAP RISK SOURCE - MONTH //
        $res_riSo_month_sub1 = DashboardModel::grapDetailRiskSource($req, 'risksource_sub1_id');
        // GRAP RISK SOURCE SUB 1 - TOTAL //
        $res_riSosub1_detail = DashboardModel::grapDetailRiskSourceSub($req, 'risksource_sub1_id');
        // GRAP RISK SOURCE SUB 2 - TOTAL //
        $res_risksub2_detail = DashboardModel::grapDetailRiskSourceSub($req, 'risksource_sub2_id');
        // RISK SOURCE SUB 2 MONTH //
        $res_riSo_month_sub2 = DashboardModel::grapDetailRiskSource($req, 'risksource_sub2_id');
    ...
    {
        // Main assets data
        $res_assets_detail = DashboardModel::grapDetailAssets($req, 'assets_id');
        // TARGET ASSETS SUB 1 MONTH
        $res_assets_sub1_month = DashboardModel::grapDetailAssets($req, 'assets_sub1_id');
        // TARGET ASSETS SUB 1
        $res_assetssub1_detail = DashboardModel::grapDetailAssetsSub($req, 'assets_sub1_id');
        // TARGET ASSETS SUB 2
        $res_assetssub2_detail = DashboardModel::grapDetailAssetsSub($req, 'assets_sub2_id');
        // TARGET ASSETS SUB 2 MONTH
        $res_assets_sub2_month = DashboardModel::grapDetailAssets($req, 'assets_sub2_id');
    ...
    {
        $res_risk_detail = DashboardModel::grapDetailRisk($req, 'risk_id');
        $res_risk_sub1 = DashboardModel::grapDetailRiskSub($req, 'risk_sub1_id');
        $res_risk_sub1_month = DashboardModel::grapDetailRisk($req, 'risk_sub1_id');
        $res_risk_sub2 = DashboardModel::grapDetailRiskSub($req, 'risk_sub2_id');
        $res_risk_sub2_month = DashboardModel::grapDetailRisk($req, 'risk_sub2_id');
    ...
    {
        // TREND YEAR MODEL
        $res_trend_year = DashboardModel::grapTrendSoi($req);
        ...
        $data = array(
            ...
            'data_trendyear_total' => $trendYearTotalArr
        );
    ...
    {
        $grap_risk_source = DashboardModel::grapRisksourceSoi($req);
