...
<script type="text/javascript">
    $( document ).ready(function() {
        ...
        table = $('#tableIso').DataTable({
            ...
            "stateSave": true,
            "ajax": {
              "url": "{{ url('srs/internal_source/list_table') }}",
              "type": "POST",
              "data": function ( data ) {
        ...
        $('#detailSearchModal').on('shown.bs.modal', function (e) {
            ...
            $.ajax({
                url: '{{ url("srs/internal_source/detail_search") }}',
                type: 'POST',
                data: {
                  id: id,
                },
        ...
        $('#exportExcel').click(function(e) {
            ...
            // fetch('analitic/srs/internal_source/export_excel')
            // .then(resp => resp.blob())
            // .then(blob => {
        ...
        $('#formSearch').on('submit', function (e) {
            ...
            $.ajax({
                url: '{{ url("srs/internal_source/search") }}',
                type: 'POST',
                data: data,
                cache: false,
                beforeSend: function() {
