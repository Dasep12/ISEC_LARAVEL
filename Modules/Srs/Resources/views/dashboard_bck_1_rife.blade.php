                            ...
                            <div class="form-row">
                                <div class="form-group col-2">
                                    ...
                                    <select id="areaFilter" class="form-control" name="area_fil" required>
                                        @foreach ($select_area_filter as $key => $saf)
                                            <option value="{{ $key }}">{{ $saf }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-2">
                                    ...
                                    <select id="yearFilter" class="form-control" name="year_filter" required>
                                            <option value="">-- Choose --</option>
                                        @foreach ($select_year_filter as $syf)
                                ...
                                <div class="form-group col-2">
                                    ...
                                    <select id="monthFilter" class="form-control" name="month_filter" required>
                                            <option value="">-- Choose --</option>
                                        @foreach ($select_month_filter as $key => $smf)
                                            <option value="{{ $key }}">{{ $smf }}</option>
                                        @endforeach
                                    </select>
                                </div>
...
<script type="text/javascript">
    ...
    document.getElementById("rsoChart").onclick = function(evt) {
        ...
        $.ajax({
            url: '{{ url("analitic/srs/dashboard/grap_detail_risk_source") }}',
            type: 'POST',
            data: {
                "_token": "{{ csrf_token() }}",
                area_fil: area,
    ...
    document.getElementById("assetChart").onclick = function(evt) {
        ...
        $.ajax({
            url: '{{ url("analitic/srs/dashboard/grap_detail_assets") }}',
            type: 'POST',
            data: {
                "_token": "{{ csrf_token() }}",
                area_fil: area,
    ...
    document.getElementById("risChart").onclick = function(evt) {
        ...
        $.ajax({
            url: '{{ url("analitic/srs/dashboard/grap_detail_risk") }}',
            type: 'POST',
            data: {
                "_token": "{{ csrf_token() }}",
                area_fil: area,
