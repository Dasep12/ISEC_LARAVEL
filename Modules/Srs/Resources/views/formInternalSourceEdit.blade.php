            ...
            <div class="col-12">
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <div class="card">
                            <form action="internal_source/update" method="post" enctype="multipart/form-data">
                            @csrf
                                                    ...
                                                    <?php 
                                                        foreach ($data_edit_all as $key => $fle) {
                                                            ...
                                                            echo '<li class="list-group-item attached-files d-flex justify-content-between">
                                                                <a class="" href="'.site_url('uploads/srs_bi/internal_source/'.$fle->file_name).'" target="_blank">'.$fle->file_name.'</a>
                                                                <input type="text" name="attached['.$fle->file_id.']" value="'.$fle->file_name.'" hidden>
                                                                <button type="button" class="btn remove-attached text-danger" data-field-file="'.$fle->file_id.'" data-toggle="modal" data-target="#deleteModal"><i class="fa fa-trash"></i></button>
                                                                </li>';
                                                        }
                                                    ?>
                                                </ul>
    ...
    $( document ).ready(function() {
        ...
        $('#btn-dlt-attc').click(function(e) {
            ...
            $.ajax({
                ...
                url: "{{ url('srs/internal_source/delete_attached') }}",
                dataType:'json',
