                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade <?=AuthHelper::is_author() ? 'show active' : ''; ?>" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <div class="card">
                            ...
                            <form action="internal_source/save" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body px-lg-4">
                                <div class="form-row mt-2 mb-4">
                                   ...
                                   <!--  <div class="form-group col-lg-2">
                                        ...
                                        <input name="no_urut" value="" required hidden>
                                ...
                                <div class="form-row mt-2 mb-4">
                                    <div class="form-group col-3">
                                        ...
                                        <select id="area" class="form-control area js-select2" name="area[]" multiple required>
                                            <option value="">-- Choose --</option>
                                            @foreach ($select_area as $key => $area)
                                    ...
                                    <div class="form-group col-3">
                                        ...
                                        <select id="subArea1" class="form-control subArea1" name="select_subarea1" disabled required>
                                            <option value="">-- Choose --</option>
                                            @foreach ($select_subarea1 as $key => $subArea1)
                                            <option value="{{ $key }}">{{ $subArea1 }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="form-row mt-2 mb-4">
                                    <div class="form-group col-3">
                                        ...
                                        <select id="assets" class="form-control assets" name="assets" required>
                                            <option value="">-- Choose --</option>
                                            @foreach ($select_ass as $key => $ass)
                                            <option value="{{ $key }}">{{ $ass }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-row mt-2 mb-4">
                                    <div class="form-group col-3">
                                        ...
                                        <select id="riskSource" class="form-control" name="risk_source" required>
                                            <option value="">-- Choose --</option>
                                            @foreach ($select_rso as $key => $rso)
                                            <option value="{{ $key }}">{{ $rso }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-row mt-2 mb-4 col-12-OFF">
                                    <div class="form-group col-3">
                                        ...
                                        <select id="risk" class="form-control" name="risk" required>
                                            <option value="">-- Choose --</option>
                                            @foreach ($select_ris as $key => $ris)
                                            <option value="{{ $key }}">{{ $ris }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-3">
                                        ...
                                        <select id="riskLevel" class="form-control" name="risk_level" readonly required>
                                            <option value="">-- Choose --</option>
                                            @foreach ($select_rle as $key => $rle)
                                            <option value="{{ $key }}">{{ $rle }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <fieldset class="border p-4 mt-2 mb-4">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-3">
                                            ...
                                            <select id="financial" class="form-control" name="financial" required>
                                                <option value="">-- Choose --</option>
                                                @foreach ($select_fin as $key => $fin)
                                                <option value="{{ $key }}">{{ $fin }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group col-3">
                                            ...
                                            <select id="sdm" class="form-control" name="sdm" required>
                                                <option value="">-- Choose --</option>
                                                @foreach ($select_sdm as $key => $sdm)
                                                <option value="{{ $key }}">{{ $sdm }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group col-3">
                                            ...
                                            <select id="operational" class="form-control" name="operational" required>
                                                <option value="">-- Choose --</option>
                                                @foreach ($select_ope as $key => $ope)
                                        ...
                                        <div class="form-group col-3">
                                            ...
                                            <select id="reputation" class="form-control" name="reputation" required>
                                                <option value="">-- Choose --</option>
                                                @foreach ($select_rep as $key => $rep)
                                                <option value="{{ $key }}">{{ $rep }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                      ...
                                      <form id="form-filter" class="form-horizontal">
                                            <div class="form-row">
                                                <div class="form-group col-2">
                                                    ...
                                                    <select id="areaFilter" class="form-control" name="area_fil" required>
                                                        <option value="">-- Choose --</option>
                                                        @foreach ($select_area_filter as $key => $aref)
                                                        <option value="{{ $key }}">{{ $aref }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
...
<div class="modal fade" id="approveModal" tabindex="-1" aria-labelledby="approveModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="srs/internal_source/approve" method="POST">
                @csrf
...
<div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="srs/internal_source/delete" method="POST">
                @csrf
                <div class="modal-body">
...
<script type="text/javascript">
    $( document ).ready(function() {
        ...
        table = $('#tableIso').DataTable({
            ...
            "ajax": {
              "url": "{{ url('srs/internal_source/listTable') }}",
              "type": "POST",
              "data": function ( data ) {
        ...
        $('#subArea1').change(function (e) {
            ...
            if (val) {
                $.ajax({
                    url: '{{ url("srs/internal_source/get_sub_area2") }}',
                    type: 'POST',
                    data: {
                      idcateg: val,
                    },
        ...
        $('#subArea2').change(function (e) {
            ...
            $.ajax({
                url: '{{ url("srs/internal_source/get_sub_area3") }}',
                type: 'POST',
                data: {
                  idcateg: val,
                },
        ...
        $('#assets').change(function (e) {
            ...
            $.ajax({
                url: '{{ url("srs/internal_source/get_sub_assets") }}',
                type: 'POST',
                data: {
                  idcateg: val,
                },
                ...
                if(data) {
                    ...
                    $('#subAssets').change(function (e) {
                        ...
                        $.ajax({
                            url: '{{ url("srs/internal_source/get_sub_assets2") }}',
                            type: 'POST',
                            data: {
                              idcateg: val,
                            },
        ...
        $('#riskSource').change(function (e) {
            ...
            $.ajax({
                url: '{{ url("srs/internal_source/get_sub_risksource") }}',
                type: 'POST',
                data: {
                  idcateg: val,
                },
            ...
            .done(function(data) {
                if(data) {
                    ...
                    $('#subRiskSource').change(function (e) {
                        ...
                        $.ajax({
                            url: '{{ url("srs/internal_source/get_sub_risksource2") }}',
                            type: 'POST',
                            data: {
                              idcateg: val,
                            },
        ...
        $('#risk').change(function (e) {
            ...
            $.ajax({
                url: '{{ url("srs/internal_source/get_sub_risk") }}',
                type: 'POST',
                data: {
                  idcateg: val.split(":")[0],
                },
            ...
            .done(function(data) {
                if(data) {
                    ...
                    $('#subRisk').change(function (e) {
                        ...
                        $.ajax({
                            url: '{{ url("srs/internal_source/get_sub_risk2") }}',
                            type: 'POST',
                            data: {
                              idcateg: val,
                            },
        ...
        $('#exportExcel').click(function(e) {
            ...
            var link = '{{ url("srs/internal_source/export_excel") }}'+param;
