...
class ModulesControllers extends Controller
{
    ...
    public function index(): View
    {
        ...
        $query = DB::select("SELECT am.id , am.name as nama_module , am.code , aa.name as nama_apps  FROM admisec_modules am left join admisec_apps aa on aa.id = am.apps_id");
        $data = [
            'link'     => '',
            'contents' => 'setting.master_module.master',
            'aplikasi'     => $query
        ];
